...
def add_parser(sub) -> None:
    ...
    q = p("check", "check the token, the integration, the parent page and the user (prints key=value)", cmd_check)
    q.add_argument("--send-test", action="store_true",
                   help="make a test page under the parent page that @mentions the user")
    ...
    q.add_argument("--mention", action="store_true", help="@mention the user, so Notion notifies them")
